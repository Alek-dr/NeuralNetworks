...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.test = QtGui.QLabel(self.SLP)
        self.test.setGeometry(QtCore.QRect(140, 220, 59, 14))
        ...
        self.iterations = QtGui.QLabel(self.SLP)
        self.iterations.setGeometry(QtCore.QRect(140, 250, 59, 14))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.test.setText(_translate("MainWindow", "Класс:", None))
        self.iterations.setText(_translate("MainWindow", "Итераций", None))
